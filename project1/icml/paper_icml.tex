...
%\icmltitlerunning{Replicating Sutton's $TD(\lambda)$}

\begin{document}

    \twocolumn[
    \icmltitle{Replicating Sutton's $TD(\lambda)$ Algorithm}
    ...
    \begin{icmlauthorlist}
        \icmlauthor{Carlos Souza}{equal,to}
    \end{icmlauthorlist}

    \icmlaffiliation{to}{Georgia Institute of Technology, São Paulo, Brazil}
    ...
    \begin{figure}[ht]
        \includegraphics[scale=0.23]{../images/random_walk.eps}
        \centering
